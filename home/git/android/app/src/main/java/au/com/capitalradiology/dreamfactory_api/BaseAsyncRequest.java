package au.com.capitalradiology.dreamfactory_api;
...
public class BaseAsyncRequest extends AsyncTask<Void, Void, Boolean> {
    ...
    protected String applicationApiKey = "ef67fd2579b77ab919ed1b4354c1f13f9b7be9ae9fe11afc6eb258364674f07b"; // automatically added to the header
    ...
    private static String BASE_URL = "https://df-capitalradiology.enterprise.dreamfactory.com/api/v2";
    private static final String DF_ANDROID_API_KEY = "ef67fd2579b77ab919ed1b4354c1f13f9b7be9ae9fe11afc6eb258364674f07b";
    // instance url, for example http://localhost:8080/api/v2
    protected String baseInstanceUrl = BASE_URL;
